###########Downloading bug reports, retrieving needed info, labeling bug reports#################
...
###########building BRM techniques based on WE-based or VSM-based feature vectors of bug reports#################
